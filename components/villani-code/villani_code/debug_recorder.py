...
class DebugRecorder:
    ...
    def record_command_environment(
        ...
        *,
        ...
        discovered_private_roots: list[str],
        environment_variables_removed: list[str],
        path_entries_removed: int,
        runner_owned_variables_considered: list[str],
        possible_private_path_variables_flagged: list[str],
        cwd: str,
        executable: str,
        tool_call_id: str = "",
        turn_index: int | None = None,
        ...
        payload = {
            ...
            "discovered_private_roots": discovered_private_roots,
            "environment_variables_removed": environment_variables_removed,
            "path_entries_removed": path_entries_removed,
            "runner_owned_variables_considered": runner_owned_variables_considered,
            "possible_private_path_variables_flagged": possible_private_path_variables_flagged,
            "cwd": cwd,
