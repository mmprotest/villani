...
def test_real_reviewer_payload_normalizes_and_validates():
    raw = {
        ...
        "score": 10,
        "decision": "accept",
        "summary": "The patch correctly implements the required pricing logic.",
        "evidence": "Runner exit code: 0. Stdout confirms tests pass.",
        "issues": [],
        "recommended_action": "Accept attempt",
        "confidence": 0.95,
