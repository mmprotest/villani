export declare const ADAPTIVE_VERIFICATION_PLAN_SCHEMA_VERSION: "villani.adaptive_verification_plan.v1";
export declare const BINARY_VERIFICATION_DECISION_SCHEMA_VERSION: "villani.binary_verification_decision.v1";
export declare const REVIEW_PACKAGE_SCHEMA_VERSION: "villani.review_package.v1";
export declare const HUMAN_OUTCOME_SCHEMA_VERSION: "villani.human_outcome.v1";
export declare const SUPERVISION_METRICS_SCHEMA_VERSION: "villani.supervision_metrics.v1";
export declare const GATE_D_SCHEMA_VERSION: "villani.gate_d.v1";
export declare const ADAPTIVE_VERIFICATION_POLICY_VERSION: "adaptive_verification_v1";
export type AdaptiveAccountingStatus = "complete" | "partial" | "unknown" | "not_applicable";
export type VerificationRiskTier = "standard" | "elevated" | "critical";
export type VerificationNodeStatus = "passed" | "failed" | "unavailable" | "infrastructure_error" | "not_run" | "not_applicable";
...
export interface AdaptiveVerificationPlan {
    ...
    qualification_state: "qualified" | "provisional" | "experimental" | "unsupported" | "unknown";
    historical_failure_modes: string[];
    nodes: Array<{
        node_id: string;
        kind: "repository_validation" | "focused_probe" | "changed_test_execution" | "static_checks" | "diff_integrity" | "generated_artifact_exclusion" | "requirement_mapping" | "semantic_verifier" | "independent_second_verifier" | "manual_review";
...
export interface BinaryVerificationDecision {
    ...
    verifier_provenance: Array<{
        ...
        invocation_status: "completed" | "not_invoked" | "malformed_output" | "timeout" | "error";
        independent: boolean;
        artifact_path: string | null;
    }>;
    verification_cost: AdaptiveMoneyAccounting;
    normalized_from: "accepted" | "rejected" | "unclear" | "error" | "deterministic_failure";
}
...
export type HumanOutcomeKind = "accepted_as_is" | "corrected_before_use" | "reverted" | "reopened_defect" | "false_acceptance" | "false_rejection";
...
export type GateDStrategy = "strongest_only" | "accepted_change_optimizer" | "optimizer_plus_adaptive";
...
export interface GateDReport {
    ...
    arms: GateDArm[];
    checks: Array<{
        check: "matched_founder_cases" | "accepted_as_is_no_regression" | "zero_false_acceptance" | "lower_cost_or_time" | "lower_review_burden" | "explainability" | "safe_fallback";
        status: "pass" | "fail" | "insufficient_evidence";
        reason: string;
    }>;
    warnings: string[];
