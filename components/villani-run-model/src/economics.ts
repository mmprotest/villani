...
export const ACCEPTED_CHANGE_POLICY_VERSION =
  "accepted_change_economics_v1" as const;
export const ECONOMICS_CONFIGURATION_SCHEMA_VERSION =
  "villani.accepted_change_economics_configuration.v1" as const;
export const ROUTE_POLICY_SCHEMA_VERSION = "villani.route_policy.v1" as const;
export const ROUTE_PLAN_SCHEMA_VERSION = "villani.route_plan.v1" as const;
export const ECONOMICS_OBSERVATION_SCHEMA_VERSION =
  "villani.economics_observation.v1" as const;
export const ECONOMICS_SNAPSHOT_SCHEMA_VERSION =
  "villani.economics_snapshot.v1" as const;
export const ROUTE_POLICY_EVALUATION_SCHEMA_VERSION =
  "villani.route_policy_evaluation.v1" as const;
export const ROUTE_POLICY_PUBLICATION_SCHEMA_VERSION =
  "villani.route_policy_publication.v1" as const;
export const ONLINE_EVIDENCE_UPDATE_SCHEMA_VERSION =
  "villani.online_evidence_update.v1" as const;

export type EconomicsAccountingStatus =
  | "complete"
  | "partial"
  | "unknown"
  | "not_applicable";
...
export interface EconomicsProfile {
  ...
  cost_distributions: Record<
    string,
    Record<string, QualificationDistribution>
  >;
