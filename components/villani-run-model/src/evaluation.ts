...
export type EvaluationAccountingStatus =
...
export interface EvaluationTrialV1 {
  ...
  human_outcome:
    "accepted_as_is" | "accepted_after_correction" | "rejected" | null;
...
export type EvaluationProtocolDocument =
  | EvaluationSuiteV1
  | EvaluationTaskV1
  | EvaluationTrialV1
  | HumanReviewV1
...
export const EVALUATION_SCHEMA_VERSIONS = Object.freeze([
