export const QUALIFICATION_POLICY_VERSION =
  "repository_qualification_v1" as const;
export const QUALIFICATION_CONFIGURATION_SCHEMA_VERSION =
  "villani.repository_qualification_configuration.v1" as const;
export const QUALIFICATION_OBSERVATION_SCHEMA_VERSION =
  "villani.qualification_observation.v1" as const;
export const QUALIFICATION_INVALIDATION_SCHEMA_VERSION =
  "villani.qualification_invalidation.v1" as const;
export const QUALIFICATION_SNAPSHOT_SCHEMA_VERSION =
  "villani.qualification_snapshot.v1" as const;
export const GATE_C_SCHEMA_VERSION = "villani.gate_c.v1" as const;
...
export type QualificationBackoffLevel =
...
export interface QualificationObservation {
  ...
  source_kind:
    | "evaluation_trial"
    | "imported_qualification_evidence"
    | "canonical_run";
  ...
  profile_source:
    | "authoritative_run_classification"
    | "explicit_evaluation_profile";
