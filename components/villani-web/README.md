...
Villani Console consumes the shared monochrome terminal design tokens from
...
The shared `ProductShell` supplies one persistent LOCAL/TEAM navigation system,
compact status header, keyboard-visible
