...
export const VILLANI_SCHEMA_FILE_BY_VERSION = {
    ...
    "villani.agent_system_config.v1": "agent-system-config.schema.json",
    "villani.role_bindings.v1": "role-bindings.schema.json",
    "villani.agent_invocation_identity.v1": "agent-invocation-identity.schema.json",
    "villani.cli_invocation.v1": "cli-invocation.schema.json",
    "villani.cli_process_result.v1": "cli-process-result.schema.json",
    "villani.cli_output_tail.v1": "cli-output-tail.schema.json",
    "villani.codex_coder_result.v1": "codex-coder-result.schema.json",
    "villani.claude_coder_result.v1": "claude-coder-result.schema.json",
